...
The tool appends the provided `fact` to a special `GEMINI.md` file located in the user's home directory (`~/.a-coder/GEMINI.md`). This file can be configured to have a different name.
...
```
save_memory(fact="The project I'm currently working on is called 'a-coder-cli'.")
```
