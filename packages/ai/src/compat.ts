 ...
 *
 * Existing apps switch imports from "@theatechcorporation/pi-ai" to
 * "@theatechcorporation/pi-ai/compat" unchanged; new code uses `createModels()`
...
/** @deprecated Static catalog read. Use `getBuiltinModel` from "@theatechcorporation/pi-ai/providers/all" or `Models.getModel()`. */
export const getModel = getBuiltinModel;

/** @deprecated Static catalog read. Use `getBuiltinModels` from "@theatechcorporation/pi-ai/providers/all" or `Models.getModels()`. */
export const getModels = getBuiltinModels;

/** @deprecated Static catalog read. Use `getBuiltinProviders` from "@theatechcorporation/pi-ai/providers/all" or `Models.getProviders()`. */
