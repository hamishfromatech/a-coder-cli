...
// live under "@theatechcorporation/pi-ai/providers/*", API implementations under
// "@theatechcorporation/pi-ai/api/*", the old global API under
// "@theatechcorporation/pi-ai/compat".
