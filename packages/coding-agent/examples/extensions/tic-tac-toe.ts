...
import type { ExtensionAPI, ExtensionContext, Theme, ToolExecutionMode } from "@theatechcorporation/pi-coding-agent";
import { type Component, matchesKey, Text, truncateToWidth, visibleWidth } from "@theatechcorporation/pi-tui";
