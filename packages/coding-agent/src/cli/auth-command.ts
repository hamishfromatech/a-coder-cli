...
/** Extract the request credential (API key or bearer token) from resolved request auth. */
export function getAuthCredential(auth: ResolvedRequestAuth | undefined): string | undefined {
