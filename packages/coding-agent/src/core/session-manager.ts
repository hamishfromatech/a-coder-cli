import { type AgentMessage, uuidv7 } from "@theatechcorporation/pi-agent-core";
...
export interface CompactionEntry<T = unknown> extends SessionEntryBase {
	...
	details?: T;
	/** True if generated by an extension, undefined/false if a-coder-cli-generated (backward compatible) */
	fromHook?: boolean;
}
...
export interface BranchSummaryEntry<T = unknown> extends SessionEntryBase {
	...
	details?: T;
	/** True if generated by an extension, false if a-coder-cli-generated */
	fromHook?: boolean;
}
 ...
 * Encodes cwd into a safe directory name under ~/.a-coder-cli/agent/sessions/.
 */
...
export class SessionManager {
		...
		if (existsSync(this.sessionFile)) {
			...
			if (this.fileEntries.length === 0) {
				...
				if (statSync(explicitPath).size > 0) {
					throw new Error(`Session file is not a valid session: ${explicitPath}`);
				}
				this.newSession();
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.a-coder-cli/agent/sessions/<encoded-cwd>/).
	 */
