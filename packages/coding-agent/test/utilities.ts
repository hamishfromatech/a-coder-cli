...
import { getModel, type OAuthCredentials, type OAuthProvider } from "@theatechcorporation/pi-ai/compat";
import { getOAuthApiKey } from "@theatechcorporation/pi-ai/oauth";
...
// ============================================================================
// OAuth API key resolution from ~/.a-coder/agent/auth.json
// ============================================================================

const AUTH_PATH = join(homedir(), ".a-coder", "agent", "auth.json");
...
/**
 * Check if a provider has credentials in ~/.a-coder/agent/auth.json
 */
...
export const PI_AGENT_DIR = join(homedir(), ".a-coder", "agent");

/**
 * Get an AuthStorage instance backed by ~/.a-coder/agent/auth.json
