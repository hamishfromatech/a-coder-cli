...
For TypeScript definitions in your project, inspect `node_modules/@theatechcorporation/pi-coding-agent/dist/` and `node_modules/@theatechcorporation/pi-ai/dist/`.
