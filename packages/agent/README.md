# @theatechcorporation/pi-agent-core

Stateful agent with tool execution and event streaming. Built on `@theatechcorporation/pi-ai`.

## Installation

```bash
npm install @theatechcorporation/pi-agent-core
```
...
```typescript
declare module "@theatechcorporation/pi-agent-core" {
...
```typescript
import { Agent, streamProxy } from "@theatechcorporation/pi-agent-core";
...
```typescript
import { agentLoop, agentLoopContinue } from "@theatechcorporation/pi-agent-core";
