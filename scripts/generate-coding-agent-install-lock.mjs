...
const internalPackagePrefix = "@theatechcorporation/pi-";
const installPackageName = "@theatechcorporation/pi-coding-agent-install";
...
function createInstallerPackageJson(codingAgentPackage) {
	const packageJson = {
		...
		private: true,
		description: "Lockfile root used by the A-Coder CLI installer and updater.",
		dependencies: {
