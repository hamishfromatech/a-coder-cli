import { createAssistantMessageEventStream, Type } from "@theatechcorporation/pi-ai";
import { complete, getModel, getProviders } from "@theatechcorporation/pi-ai/compat";
import {
	Agent,
	bashExecutionToText,
	convertToLlm,
