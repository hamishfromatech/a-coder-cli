		...
		<div className="flex flex-col gap-2">
			{visible.map((key) => {
				...
				return (
					...
					>
						<div className="border-b border-pi-border bg-pi-surface px-2 py-1 text-3xs font-semibold uppercase tracking-wide text-pi-text-muted">
							{key}
						</div>
						<pre className="max-h-32 overflow-auto p-2 font-mono text-2xs leading-relaxed text-pi-text-secondary">
							{widget.lines.join("\n")}
						</pre>
					</div>
				);
